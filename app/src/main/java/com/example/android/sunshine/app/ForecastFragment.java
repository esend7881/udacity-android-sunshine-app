    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_refresh:
                Log.i(LOG_TAG, "Refreshing - Fetch Weather Task");
                new FetchWeatherTask().execute("92109");
                return true;
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] strings) {
            if (strings != null && strings.length > 0) {
                ...
                Log.v(LOG_TAG, "onPostExecute: " + Arrays.toString(strings));
                setForecaseAdapter(strings);
            }
        }
 ...
 */
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                String zip = params != null && params.length > 0 ? params[0] : "94043";
                ...
                Log.i(LOG_TAG, "Connecting to " + url);
